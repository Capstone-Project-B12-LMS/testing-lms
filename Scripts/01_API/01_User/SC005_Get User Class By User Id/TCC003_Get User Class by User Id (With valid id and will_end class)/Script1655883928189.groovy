...
response = WS.sendRequest(findTestObject('01_API/01_User/SC005_Get User Class By User Id/TC003_Get User Class by User Id (With valid id and will_end class)'))
