...
WebUI.setText(findTestObject('02_Web/06_Settings/input_email_email'), 'salsagmail.com')

WebUI.click(findTestObject('02_Web/06_Settings/SC025_Edit Profile/change_email_ico'))

WebUI.click(findTestObject('02_Web/06_Settings/button_Change'))

WebUI.verifyElementPresent(findTestObject('02_Web/06_Settings/SC025_Edit Profile/popup_failed'), 0)
